...
class RiskExplainer(BaseExplainer):
    ...
    def explain_calibration(self) -> str:
        return (
            ...
            "then hedging optimization solves constrained allocations against chosen objectives."
        )
    ...
    def explain_outputs(self) -> str:
        return (
            ...
            "Backtesting modules can report hit rates, drawdowns, and stability diagnostics for ongoing model governance."
        )
